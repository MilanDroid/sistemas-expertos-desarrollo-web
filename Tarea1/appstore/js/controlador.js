...
var categorias = [];
var store = document.getElementById('apps-menu');
(()=>{
...
categorias.forEach( (element) => {
    let card = `<div class="col-2">
        <div class="card card-active p-2 m-2">
            <img src="img/app-icons/1.webp" srcset="img/app-icons/1.webp" class="card-img-top" alt="App 1">
            <div class="card-body p-0">
                <h5 class="card-title">App 1</h5>
                <h6 class="card-subtitle">Desarrollador 1</h6>
                ...
                <h5 class="card-title font-weight-bold">$3.12</h5>
            </div>
        </div>
    </div>`;
    // store.innerHTML = `${element.nombreCategoria}`;
});